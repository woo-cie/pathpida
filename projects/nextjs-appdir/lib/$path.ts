...
export const pagesPath = {
  ...
  _pid: (pid: string | number) => ({
    $url: (url?: { query?: OptionalQuery_1qd20e9, hash?: string }) => ({ pathname: '/[pid]' as const, query: { pid, ...url?.query }, hash: url?.hash, path: `/${pid}${buildSuffix(url)}` as const })
  }),
  "blog": {
    _slug: (slug: string[]) => ({
      $url: (url: { query: Query_g05ywg, hash?: string }) => ({ pathname: '/blog/[...slug]' as const, query: { slug, ...url.query }, hash: url.hash, path: `/blog/${slug?.join('/')}${buildSuffix(url)}` as const })
    }),
    "hoge": {
      _fuga: (fuga?: string[]) => ({
  ...
  "_ignore": {
    $url: (url?: { hash?: string }) => ({ pathname: '/.ignore' as const, hash: url?.hash, path: `/.ignore${buildSuffix(url)}` as const })
  },
  _a: (a: string | number) => ({
    "b": {
      _c: (c: string[]) => ({
  ...
  $url: (url: { query: Query_1j04kwd, hash?: string }) => ({ pathname: '/' as const, query: url.query, hash: url.hash, path: `/${buildSuffix(url)}` as const }),
  "children": {
    "%E6%97%A5%E6%9C%AC%E8%AA%9E": {
    ...
    _pid: (pid: string | number) => ({
      $url: (url?: { query?: OptionalQuery_19vdpqy | undefined, hash?: string | undefined } | undefined) => ({ pathname: '/children/[pid]' as const, query: { pid, ...url?.query }, hash: url?.hash })
    }),
    "aaa": {
      _bbb: (bbb: string[]) => ({
        "ccc": {
    ...
    "blog": {
      _slug: (slug: string[]) => ({
        $url: (url: { query: Query_1rrk9o7, hash?: string | undefined }) => ({ pathname: '/children/blog/[...slug]' as const, query: { slug, ...url.query }, hash: url.hash })
      }),
      "hoge": {
